                                ...
                                <div class="section">   
                                    ...
                                    <p>  <strong>    {{$key}} )</strong>{{$mcq_ques->question}} X {{$mcq_ques->marks}}</p>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input readonly value="{{$answer->answer}}" name="answer[]" type="text" class="form-control{{$exam->exam_details->where('attachment',null)[$key]->answer_id == $answer->id?'bg-warning':''}}"  />
                                            </label>
                                            </div>
                                        @empty 
